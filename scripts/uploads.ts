...
export const uploadCommunityLogo = async (event: React.ChangeEvent<HTMLInputElement>): Promise<string> => {
  ...
  return (EnvironmentVariable.Supabase.storage + "/images/" + data?.path) as string;
}