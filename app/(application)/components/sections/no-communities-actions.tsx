...
export function NoCommunitiesActions() {
  return (
    <Box className="border-b p-6">
      <Heading size="lg">{ApplicationContent.Home.NoCommunity.title}</Heading>
      <Subtitle size="xs">
      ...
      <Grid className="mt-4" cols={2}>
        <Card>
          ...
          <Subtitle size="xs" className="mt-2 pb-2">
            {
              ApplicationContent.Home.NoCommunity.Action.CreateCommunity
                .subtitle
            }
          </Subtitle>
        ...
        <Card className="!bg-product-secondary h-full">
          ...
          <Link href={'/explore?tab=trending'} className="mt-2 block">
            <Subtitle
              size="sm"
              className="!text-white flex flex-row items-center gap-1 hover:gap-2 transition-all">
